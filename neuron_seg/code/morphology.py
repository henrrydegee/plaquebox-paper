...
img2 = np.array(Image.open("../image/preprocessing_pipeline/threshold_original_170.png"),dtype=np.uint8)
...
cv2.imwrite("../image/preprocessing_pipeline/dilation_erosion2.png", img3_erosion)
