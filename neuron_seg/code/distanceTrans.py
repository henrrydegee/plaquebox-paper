...
im_overall = np.array(Image.open("../image/preprocessing_pipeline/overall_edge.png"),dtype=np.uint8) / 255
im_patch = np.array(Image.open("../image/preprocessing_pipeline/Neuron_patch.png"),dtype=np.uint8) / 255 
...
cv2.imwrite("../image/preprocessing_pipeline/transformed_img.png", im_transform)
